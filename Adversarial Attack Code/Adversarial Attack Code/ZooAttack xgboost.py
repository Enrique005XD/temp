...
df=pd.read_csv('Merged Dataset 6.csv')
...
def get_adversarial_examples(x_train, y_train):
    ...
    # Create and fit XGboostClassifier
    model = XGBClassifier(n_estimators=1000)
    model.fit(X=x_train, y=y_train)

    # Create ART classifier for scikit-learn XGBoostClassifier
...
model = XGBClassifier(#nthread = RD.best_params_.get('nthread'),
